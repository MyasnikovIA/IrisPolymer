...
import { root, isAncestor, isDescendant, get, translate, isPath, set, normalize } from '/v3/path.js';
/* for notify, reflect */

import { camelToDashCase, dashToCamelCase } from '/v3/case-map.js';
import { PropertyAccessors } from '/v3/property-accessors.js';
/* for annotated effects */

import { TemplateStamp } from '/v3/template-stamp.js';
import { sanitizeDOMValue } from '/v3/settings.js'; // Monotonically increasing unique ID used for de-duping effects triggered
