...
import {forEachRule, processVariableAndFallback, rulesForStyle, toCssText, gatherStyleText} from '/v3/style-util.js';
import {MIXIN_MATCH, VAR_ASSIGN} from '/v3/common-regex.js';
import {detectMixin} from '/v3/common-utils.js';
import {StyleNode} from '/v3/css-parse.js'; // eslint-disable-line no-unused-vars
