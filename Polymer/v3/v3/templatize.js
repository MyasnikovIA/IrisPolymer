...
import { MutableData } from '/v3/mutable-data.js';
import { strictTemplatePolicy } from '/v3/settings.js';
import { wrap } from '/v3/wrap.js'; // Base class for HTMLTemplateElement extension that has property effects
